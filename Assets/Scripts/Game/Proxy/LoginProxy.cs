...
using System.Linq;
	...
	public class LoginProxy 
	{
        ...
        */
        public const int CG_CreateRole = 101;
		/**
        *返回
        *Server
		*	登陆错误码返回 
        ...
        */
        public const int GC_LoginBack = 102;
		/**
        *返回
        *Server
		*	账号ID 
        ...
        */
        public const int CG_SERVER_ID = 105;
		/**
        *返回
        *Server
		*	服务器ID 
        ...
        */
        public const int GC_SERVER_ID = 106;
