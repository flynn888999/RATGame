...
using System.Linq;
	...
	public class PlayerProxy 
	{
        ...
        */
        public const int GC_PLAYERS = 103;
		/**
        *请求创建角色
        *Client
		*	角色名称 
        ...
        */
        public const int CG_CREATE = 104;
		/**
        *返回创建角色
        *Server
		*	角色ID 
		...
		*	Name:sex		TYPE:byte		SIZE:1
        */
        public const int GC_CREATE = 105;
		/**
        *接收
        *Client
		*	角色ID 
		*	Name:playerId		TYPE:long		SIZE:8
        */
        public const int CG_DELETE = 106;
		/**
        *返回
        *Server
		*	角色ID 
		*	Name:playerId		TYPE:long		SIZE:8
        */
        public const int GC_DELETE = 107;
		/**
        *接收
        *Client
		*	账号ID 
        ...
        */
        public const int GC_GS_DOWN = 110;
		/**
        *更新金币数量
        *Server
		*	金币值 
        ...
        */
        public const int GC_UPDATE_GOLD = 111;
		/**
        *更新钻石数量
        *Server
		*	钻石值 
		...
		*	Name:sourceType		TYPE:short		SIZE:2
        */
        public const int GC_UPDATE_DIAMOND = 112;
		/**
        *推送
        *Server
		*	基础分 
